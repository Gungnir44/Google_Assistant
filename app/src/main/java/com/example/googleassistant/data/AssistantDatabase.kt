    ...
    companion object{
        ...
        fun getInstance(context: Context) : AssistantDatabase{
            synchronized(this){
                ...
                if(instance == null){
                    instance = Room.databaseBuilder(context.applicationContext, AssistantDatabase :: class.java, "assistant_messages_database").fallbackToDestructiveMigration().build()
                    INSTANCE = instance
